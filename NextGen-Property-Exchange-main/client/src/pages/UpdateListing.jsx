  ...
  return (
    <div >
      <main className='p-6 max-w-5xl mx-auto bg-gray-100 shadow-lg rounded-lg mt-10'>
        <h1 className='text-4xl font-bold text-center text-gray-800 my-8'>Update Listing</h1>
          ...
          <div className='flex flex-col gap-6 flex-1'>
            ...
            <div className='flex flex-wrap gap-6'>
              <div className='flex items-center gap-3'>
                <input type='number' id='bedrooms' min='1' max='10' required className='p-3 border border-indigo-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:outline-none' onChange={handleChange} value={formData.bedrooms} />
                <p className='text-gray-600'>Beds</p>
              </div>

              <div className='flex items-center gap-3'>
                <input type='number' id='bathrooms' min='1' max='10' required className='p-3 border border-indigo-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:outline-none' onChange={handleChange} value={formData.bathrooms} />
